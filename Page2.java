          ...
          public void actionPerformed(ActionEvent e)
           {
             ...
             { 
                 while(true)
               {
                 rowno=JOptionPane.showInputDialog(windowContent,"ENTER THE ROW NO.(0-3) ","INPUT ROW", JOptionPane.QUESTION_MESSAGE);
          ...
          public void actionPerformed(ActionEvent e)
           {
             try
             {
                 while(true)
               {
                 colno=JOptionPane.showInputDialog(windowContent,"ENTER THE COLUMN NO.(0-9) ","INPUT ROW", JOptionPane.QUESTION_MESSAGE);
